...
import com.study.springbootboard.config.TestSecurityConfig;
...
class ArticleControllerTest {
    ...
    @WithUserDetails(value = "nanaTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)

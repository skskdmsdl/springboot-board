...
import com.study.springbootboard.domain.constant.FormStatus;
import com.study.springbootboard.domain.constant.SearchType;
...
import com.study.springbootboard.dto.request.ArticleRequest;
import com.study.springbootboard.dto.response.ArticleResponse;
import com.study.springbootboard.service.ArticleService;
import com.study.springbootboard.service.PaginationService;
import com.study.springbootboard.util.FormDataEncoder;
...
@WebMvcTest(ArticleController.class) // WebMvcTest는 모든 컨트롤러를 다 읽기 때문에 테스트 대상 컨트롤러만 빈으로 읽음
class ArticleControllerTest {
    ...
    // 테스트 패키지는 생성자가 하나만 있는 경우 @Autowired를 생략 할 수 없음
    // 실제 controller 패키지에서는 @Autowired 생략 가능
